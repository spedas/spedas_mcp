...
For a full analysis (turbulence spectrum, boundary/MVA, particle moments, conjunctions, …), prefer a skill — see `/spedas-mcp:analyze` or the `spedas-skills-index` skill.
