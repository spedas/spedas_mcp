...
def _sync_after_download(dataset_id: str, cdf_path: Path, source_url: str) -> None:
    ...
    try:
        from spedas_mcp.backends.cdaweb.validation import sync_metadata
        sync_metadata(
...
def fetch_data(
    ...
    """
    from spedas_mcp.backends.cdaweb.metadata import _resolve_metadata
...
def _download_cdf_file(
    ...
    from spedas_mcp.backends.cdaweb.http import DOWNLOAD_TIMEOUT
