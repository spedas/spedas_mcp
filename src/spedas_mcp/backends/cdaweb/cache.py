...
def _get_observatories_dir():
    ...
    from spedas_mcp.backends.cdaweb.catalog import get_observatories_dir
...
def _fetch_from_master_cdf(dataset_id: str) -> dict | None:
    ...
    from spedas_mcp.backends.cdaweb.metadata import _fetch_from_master_cdf as _impl
...
def _fetch_cdaweb_time_ranges() -> dict[str, dict]:
    ...
    from spedas_mcp.backends.cdaweb.scripts.build_catalog import fetch_cdaweb_catalog
...
def refresh_time_ranges(observatory: str | None = None) -> dict:
    ...
    from spedas_mcp.backends.cdaweb.catalog import invalidate_observatory_cache
...
def rebuild_catalog(observatory: str | None = None) -> dict:
    ...
    """
    from spedas_mcp.backends.cdaweb.scripts.build_catalog import (
        build_all,
