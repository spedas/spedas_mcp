"""
spedas_mcp.backends.spice — vendored SPICE ephemeris backend.
...
Quick start::
    ...
    from spedas_mcp.backends.spice import get_position
...
Python API
----------
These functions are available when importing spedas_mcp.backends.spice as a library:
